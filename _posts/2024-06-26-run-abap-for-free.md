...
We decided to invest in a new functionality which will help our customers to run simple and for free ABAP code.
Let's see what ChatGPT thinks about this.<br>
<img src="{{ site.baseurl }}/images/chatgpt-run-abap-for-free.png" width="800em"><br>
<img src="{{ site.baseurl }}/images/chatgpt-easily-run-abap.png" width="800em"><br>
...
You can use any database which are supported, like H2, PostgreSQL, MySQL, Snowflake, HANA etc.<br>
...
ENDCLASS.
```
It is a simple DAO for employees management which uses ABAP inline SQL with hardcoded data.<br>
To run this ABAP code, follow the steps before or if you prefer, watch a video of the steps [here](TODO).
...
1. Open Kronos and create a simple ABAP Starter project
   ...
   - At the `Welcome` view search for `ABAP` and select `ABAP Starter` template<br>
      <img src="{{ site.baseurl }}/images/steps-select-template.png" width="800em">
   - Type project and file name - for example `my-first-abap-project` and click on `Ok` button<br>
     <img src="{{ site.baseurl }}/images/steps-template-data.png" width="800em">
   - An ABAP starter project will be automatically generated and published after a few seconds<br>
     <img src="{{ site.baseurl }}/images/steps-generated-abap-project.png" width="800em">
   - You can publish it manually as well by clicking on `Publish all` button. It is required when you make code change to take effect.<br>
     <img src="{{ site.baseurl }}/images/steps-publish-all-button.png" width="800em">
   ...
   - Now, let's check whether the generated project works.
     - Refresh the workspace using the `Refresh` button<br>
       <img src="{{ site.baseurl }}/images/steps-refresh-workspace-button.png" width="800em">
     - Navigate to `dist/run.mjs` file and double-click on it
     - You should see `Hello world!` in the `Preview` tab.<br>
       <img src="{{ site.baseurl }}/images/steps-hello-world.png" width="800em"><br>
...
1. Create `employees` table<br>
  To work this class, we are going to need a table for the employees.<br>We will use some codbex functionalities to simplify the things.<br>
...
1. Due to issue in the ABAP transpiler (which will be fixed soon), we have to register the table in the ABAP context manually.<br>
...
1. Check the execution result
   - Once published, open [http://localhost/services/js/my-first-abap-project/dist/run.mjs](http://localhost/services/js/my-first-abap-project/dist/run.mjs) and check the console output.<br>
     You should receive status code `200` and console output like the following:<br>
     <img src="{{ site.baseurl }}/images/steps-dao-console-output.png" width="800em">
   - You can check the table content as well.
     - Go to `Database` perspective<br>
       <img src="{{ site.baseurl }}/images/steps-db-perspective-button.png" width="800em">
     ...
     - You should see that the hardcoded employee was inserted and the last name was updated<br>
       <img src="{{ site.baseurl }}/images/steps-table-content.png" width="800em">
1. We can refactor the DAO a bit in order to use the Kronos ABAP API for printing lines to the http response
   - Replace the content of `src/abap/zcl_employee_dao.clas.abap` with the following
    ...
    - Now the logs of the execution will be returned in the http response<br>
      <img src="{{ site.baseurl }}/images/steps-output-in-http-response.png" width="800em">
   
This is how we ran our existing ABAP DAO using Kronos in a few quick steps.
...
- if you have an ABAP application with thousands of code, but you don't have ABAP developers, you can still use the existing ABAP code and call it from JavaScript or TypeScript code
