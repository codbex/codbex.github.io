...
features:
  ...
  - title: Hades
    details: "Database Management for PostgreSQL, MySQL, SAP HANA, H2, and more. Database Explorer, SQL Console, Data Transfer, Data Import and Export, Anonymization"
    link: /products/hades
    linkText: Learn more
    icon:
  ...
  - title: Rhea
    details: "Entities, Forms and Reports modeling: All the model driven architecture and development supporting components"
    link: /products/rhea
    linkText: Learn more
    icon:
