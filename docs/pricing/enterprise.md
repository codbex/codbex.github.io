...
If an incident cannot be resolved within the defined SLA targets, <b>codbex</b> follows a structured escalation path:

1. **Operational Level** – Support engineering team
2. **Managerial Level** – Team lead / service manager
3. **Executive Level** – Senior management involvement
