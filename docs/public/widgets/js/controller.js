const widgetsView = angular.module('widgets', ['ideUI']);
widgetsView.controller('WidgetsViewController', ['$scope', function ($scope) {

    const urlParams = new URLSearchParams(window.location.search);
    $scope.widgetName = urlParams.get('widget');
    $scope.darkMode = urlParams.get('darkMode') || false;
    ...
    $scope.getSingleWidget = function (name) {
        if ($scope.widgetName !== null && $scope.widgetName !== undefined) {
            return name === $scope.widgetName;
        }
        return false;
    }
